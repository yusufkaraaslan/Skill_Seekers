...
class TestCliPackage:
    ...
    def test_cli_has_version(self):
        ...
        assert skill_seekers.cli.__version__ == "3.9.0.dev0"
...
class TestMcpPackage:
    ...
    def test_mcp_has_version(self):
        ...
        assert skill_seekers.mcp.__version__ == "3.9.0.dev0"
    ...
    def test_mcp_tools_has_version(self):
        ...
        assert skill_seekers.mcp.tools.__version__ == "3.9.0.dev0"
...
class TestRootPackage:
    ...
    def test_root_has_version(self):
        ...
        assert skill_seekers.__version__ == "3.9.0.dev0"
