...
class TestMiniMaxAdaptor(unittest.TestCase):
    ...
    def test_validate_api_key_valid(self):
        ...
        self.assertTrue(self.adaptor.validate_api_key("sk-api-abc123def456"))
        self.assertTrue(self.adaptor.validate_api_key("  some-long-api-key-here  "))
    ...
    def test_upload_with_real_api(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            (skill_dir / "SKILL.md").write_text(
                "You are an expert assistant for Python testing."
            )
            (skill_dir / "references").mkdir()
