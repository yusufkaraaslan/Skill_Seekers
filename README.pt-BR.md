...
[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=skill_seekers) — uma plataforma de inferência de IA multimodal completa e compatível com a OpenAI. O Skill Seekers a suporta como alvo de empacotamento/aprimoramento via `--target atlas` com `ATLAS_API_KEY`.
...
**Pré-requisitos:** Python 3.10+, Git. É novo por aqui? → **[Início Rápido à Prova de Balas](BULLETPROOF_QUICKSTART.md)** 🎯
