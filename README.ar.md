...
[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=skill_seekers) — منصة استدلال ذكاء اصطناعي متعددة الوسائط ومتوافقة مع OpenAI. يدعمها Skill Seekers كهدف للتحزيم/التحسين عبر `--target atlas` مع `ATLAS_API_KEY`.
