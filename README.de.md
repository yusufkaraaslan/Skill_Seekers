...
[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=skill_seekers) — eine vollmodale, OpenAI-kompatible KI-Inferenzplattform. Skill Seekers unterstützt sie über `--target atlas` mit `ATLAS_API_KEY` als Packaging- und Enhancement-Ziel.
...
**Voraussetzungen:** Python 3.10+, Git. Neu hier? → **[Bulletproof Quick Start](BULLETPROOF_QUICKSTART.md)** 🎯
